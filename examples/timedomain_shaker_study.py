...
def runStudy(params):
    ...
    for i in range(nFrequencies):
        ...
        extraDelta = 0.0
        examples.timedomain_shaker.run(extraDelta, params, frequency, True)
...
def doScipyOptimize():
    ...
    scipy.optimize.minimize(objective_function_scipy, np.array([50.00000000e+00]),
                            tol=0, method='L-BFGS-B', bounds=[(0.0, 100.0)], options={'eps': 1.0, 'maxiter': 1000})
