...
def plotBoth(dataSim):
    ...
    plt.tight_layout()
    plt.savefig('ZZHHHHHHHaupt_Fre_Scipy4.1.pdf', format='pdf')
    plt.show()
...
def Plot_Frequenz():
    filename = "Z_Überprüfung2Neu\iteration_PS_storage_VAR5_E3.0_to_6_with_0.1_D1_0.1_to_0.41_with_0.01_D2_0.1_to_0.41_with_0.01_D3_0.1_to_0.41_with_0.01__D4_0.1_to_0.41_with_0.01_nFrequenz=11_firstFrequenz=1_pop=100.dat"
    row = 87
